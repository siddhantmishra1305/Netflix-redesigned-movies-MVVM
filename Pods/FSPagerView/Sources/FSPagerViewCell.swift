...
open class FSPagerViewCell: UICollectionViewCell {
    ...
    open var imageView: UIImageView? {
        ...
        let imageView = UIImageView(frame: CGRect(x: 0, y: 0, width: self.contentView.frame.size.width, height: self.contentView.frame.size.height))
        imageView.contentMode = .scaleAspectFill
        self.contentView.addSubview(imageView)
       
        let overlay: UIView = UIView(frame: CGRect(x: 0, y: 0, width: self.contentView.frame.size.width, height: self.contentView.frame.size.height))
